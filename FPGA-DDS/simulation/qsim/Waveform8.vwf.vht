...
-- *****************************************************************************
-- Generated on "07/18/2025 16:52:02"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          testChronoFSM_Vers
-- 
...
ENTITY testChronoFSM_Vers_vhd_vec_tst IS
END testChronoFSM_Vers_vhd_vec_tst;
ARCHITECTURE testChronoFSM_Vers_arch OF testChronoFSM_Vers_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
SIGNAL setPreCount : STD_LOGIC;
COMPONENT testChronoFSM_Vers
	PORT (
	clk : IN STD_LOGIC;
	en : IN STD_LOGIC;
	nRst : IN STD_LOGIC;
...
-- setPreCount
t_prcs_setPreCount: PROCESS
BEGIN
	setPreCount <= '0';
WAIT;
END PROCESS t_prcs_setPreCount;
END testChronoFSM_Vers_arch;
