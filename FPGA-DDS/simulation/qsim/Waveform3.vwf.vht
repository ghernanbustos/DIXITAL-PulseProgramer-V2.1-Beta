...
-- *****************************************************************************
-- Generated on "06/06/2025 22:51:55"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          chronotest
-- 
...
ENTITY chronotest_vhd_vec_tst IS
END chronotest_vhd_vec_tst;
ARCHITECTURE chronotest_arch OF chronotest_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL clock_50 : STD_LOGIC;
SIGNAL en_chrono : STD_LOGIC;
SIGNAL nRst : STD_LOGIC;
SIGNAL overflow : STD_LOGIC;
SIGNAL precount : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL pulseOut : STD_LOGIC;
SIGNAL setPreCount : STD_LOGIC;
COMPONENT chronotest
	PORT (
...
-- en_chrono
t_prcs_en_chrono: PROCESS
BEGIN
	en_chrono <= '1';
WAIT;
END PROCESS t_prcs_en_chrono;
