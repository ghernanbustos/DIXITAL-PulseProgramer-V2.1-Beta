...
# ----------------------------------------
# If PLLV2 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.1 917 win32 2025.09.04.15:02:59
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLLV2.vho"
}
