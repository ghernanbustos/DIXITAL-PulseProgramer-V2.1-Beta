...
module hps_dds_wrapper_mm_interconnect_0_router_default_decode
  #(
...
module hps_dds_wrapper_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    hps_dds_wrapper_mm_interconnect_0_router_default_decode the_default_decode(
