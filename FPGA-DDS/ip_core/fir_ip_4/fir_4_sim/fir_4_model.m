...
% ================================================================================
% Generated on: 09/17/2024 15:47:07
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_4_mlab(single_channel_data{i}, single_channel_bank{i});
