...
entity fir_4 is
	port (
		...
		ast_source_data  : out std_logic_vector(26 downto 0);                    -- avalon_streaming_source.data
...
architecture rtl of fir_4 is
	component fir_4_0002 is
		port (
			...
			ast_source_data  : out std_logic_vector(26 downto 0);                    -- data
			ast_source_valid : out std_logic;                                        -- valid
			ast_source_error : out std_logic_vector(1 downto 0)                      -- error
		);
	end component fir_4_0002;

begin

	fir_4_inst : component fir_4_0002
		port map (
			clk              => clk,              --                     clk.clk
...
-- Retrieval info: 	<generic name="coeffFracBitWidth" value="5" />
