...
function  output = fir_sinc_sim_mlab(stimulation, bank);
 coef_matrix_in= [8,9,11,15,20,27,35,44,54,64,75,85,95,104,112,118,123,126,127,126,123,118,112,104,95,85,75,64,54,44,35,27,20,15,11,9,8];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
