...
function  output = fir_7_mlab(stimulation, bank);
 coef_matrix_in= [155,169,211,279,371,486,619,767,926,1090,1255,1415,1566,1703,1821,1918,1988,2032,2047,2032,1988,1918,1821,1703,1566,1415,1255,1090,926,767,619,486,371,279,211,169,155];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
