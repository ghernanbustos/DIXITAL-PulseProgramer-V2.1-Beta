...
function  output = fir_5_mlab(stimulation, bank);
 coef_matrix_in= [0,6,0,-12,0,24,0,-45,0,78,0,-129,0,217,0,-407,0,1294,2046,1294,0,-407,0,217,0,-129,0,78,0,-45,0,24,0,-12,0,6,0];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
