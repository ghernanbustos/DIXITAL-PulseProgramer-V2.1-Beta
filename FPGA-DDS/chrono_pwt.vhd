...
ARCHITECTURE behavioral of chrono_pwt is
	signal count : std_logic_vector(31 downto 0) := (others => '0');
BEGIN
	PROCESS(count_clk, count_en,count_nRst,preload_en) -- sensitive list
	BEGIN
		IF (count_nRst = '0') THEN -- asynchronous reset
			...
			count_overflow_db <= '0';
			-------------------------
		ELSIF (rising_edge(count_clk ) and count_en = '1') THEN -- edge activation
			IF ( preload_en = '1') THEN
				count <= count_preload; -- pre load count
			ELSE
