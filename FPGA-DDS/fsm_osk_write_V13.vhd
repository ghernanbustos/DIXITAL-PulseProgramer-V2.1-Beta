...
--   FileName:         fsm_osk_write_V13.vhd
--   Dependencies:     none
...
--
--	  Brief: 
-- 	DDS WR operation delayed one clock to let data from FSM_OSK output be set 
--		at the dds input.
--------------------------------------------------------------------------------
...
END ENTITY fsm_osk_write_V13;
------------------------------------------------
ARCHITECTURE Behavioral OF fsm_osk_write_V13 IS
  -- Signals declarations
	TYPE state_type IS (state_init1, state_latchData, state_0, state_1, state_2, state_3,state_4, state_5, state_6, state_7, state_8, state_9);	
...
--------------------------------------------------------------------------
state_transition: PROCESS (osk_clk, osk_rst_n) 	--sensitive list
	BEGIN
...
Output_logic: PROCESS (state) -- when state changes this process is active
	BEGIN							
 		CASE state IS
			...
			WHEN state_latchData =>		-- reset ff_d / latch NCO sample.
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '1';				 		
			...
			WHEN state_0 =>				 -- Concatenate I_MSB
				...
				dds_I_O_update		<= '0';
				osk_ff_rst_n		<= '1';
			WHEN state_1 =>		-- set data in dds input
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '1';			 		
				...
				dds_I_O_update		<= '0';
				osk_ff_rst_n		<= '1';
			WHEN state_2 => 				 -- Concatenate I_LSB / WR previous data
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '0';-- wr on 	
				...
				dds_I_O_update		<= '0';
				osk_ff_rst_n		<= '1';
			WHEN state_3 => -- set data in dds input
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '1';	
			...
			----------------------------
			----------------------------
			WHEN state_4 => 				 -- Concatenate Q_MSB/ WR previous data
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '0';	
				...
				osk_ff_rst_n		<= '1';
			WHEN state_5 => 				 -- set data in dds input
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '1';	
			...
			WHEN state_6 => 				 -- Concatenate Q_LSB
				...
				dds_I_O_update		<= '0';
				osk_ff_rst_n		<= '1';
			WHEN state_7 => 				-- set data in dds input
				-- DDS Write Data Control	
				dds_masterRst		<= '0';	 			
				dds_rd_n				<= '1';				 	 	
				dds_wr_n				<= '1'; 
