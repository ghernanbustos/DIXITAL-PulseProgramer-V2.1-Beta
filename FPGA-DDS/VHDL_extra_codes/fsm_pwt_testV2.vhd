...
ENTITY fsm_pwt_testV2 IS
  port (
		...
		ledOutputFlag		:  OUT std_logic
  );
END ENTITY fsm_pwt_testV2;
------------------------------------------------
ARCHITECTURE Behavioral OF fsm_pwt_testV2 IS
  -- Signals declarations
  TYPE state_type IS (state_reset, state_1, state_2,state_3,state_4,state_5,state_6);
  SIGNAL state : state_type; 														 
  CONSTANT phaseMsb  	: std_logic_vector(15 downto 0) := X"0020"; -- 00 20 
  CONSTANT phaseLsb  	: std_logic_vector(15 downto 0) := X"0100"; -- 01 00
BEGIN
	...
	BEGIN							
 		CASE state IS
			...
			WHEN state_4 => 				-- Write LSB word	 
				...
				FSK_BPSK_HOLD	<= 'Z';	
				I_O_update		<= '0';	
				dds_phase		<= phaseLsb;--X"0000";
				phaseShiftActive <= '0';
				ledOutputFlag <= '0';
			WHEN state_5 =>				-- UPDATE data	 
				--dds control				
				masterRst	 	<= '0';	
				rd_n			 	<= '1';  
				wd_n			 	<= '1';	
