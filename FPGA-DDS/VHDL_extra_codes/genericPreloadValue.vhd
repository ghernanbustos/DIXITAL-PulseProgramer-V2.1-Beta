...
entity genericPreloadValue is
    Port (
        clk : in STD_LOGIC;
        rst_n : in STD_LOGIC;
        output_data : out STD_LOGIC_VECTOR(31 downto 0)
    );
end entity genericPreloadValue;

architecture Behavioral of genericPreloadValue is
    -- Define your desired 32-bit value here 
    constant desired_value : STD_LOGIC_VECTOR(31 downto 0) := "11111111101100111011010011000000"; 
