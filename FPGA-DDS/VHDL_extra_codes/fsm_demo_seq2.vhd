...
END ENTITY fsm_demo_seq2;
------------------------------------------------
ARCHITECTURE Behavioral OF fsm_demo_seq2 IS
	...
	BEGIN							
 		CASE state IS
			...
			WHEN state_1	 =>		 					-- pre load timers one cycle
				...
				fsm_seq_timerBK_en			<= '1';  
				fsm_seq_timerBK_rst			<= '1';
				fsm_seq_timerBK_preEn		<= '1';
			...
			WHEN state_3	 =>		 			-- dso trigger / blanking on / main timer on
				...
				fsm_seq_timerBK_en			<= '1'; -- Blank window on but not reset
				fsm_seq_timerBK_rst			<= '1';
				fsm_seq_timerBK_preEn		<= '0';
