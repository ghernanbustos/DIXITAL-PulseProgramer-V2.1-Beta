...
entity genericPreloadValue3 is
    Port (
        clk : in STD_LOGIC;
        rst_n : in STD_LOGIC;
        output_data : out STD_LOGIC_VECTOR(31 downto 0)
    );
end entity genericPreloadValue3;

architecture Behavioral of genericPreloadValue3 is
    -- Define your desired 32-bit value here 
    constant desired_value : STD_LOGIC_VECTOR(31 downto 0) := "11111111111100001011110111000000"; 
